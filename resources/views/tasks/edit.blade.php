...
<form method="post" action="{{ route('tasks.update', $task) }}" class="card card-body">
    @csrf
    @method('PUT')
    <div class="mb-3">
        <label class="form-label">Título *</label>
        <input type="text" name="title" class="form-control" maxlength="255" value="{{ old('title', $task->title) }}" required>
    </div>
    <div class="mb-3">
